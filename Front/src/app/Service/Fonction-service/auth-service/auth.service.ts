...
export class AuthService {
  ...
  submitDiscord(): Observable<any> {
    return this.http.post('http://51.75.162.147:8080/auth/discord', {}, { withCredentials: true });
  }

  getCurrentUser(): Observable<any> {
    return this.http.get('http://51.75.162.147:8080/auth/current-user', { withCredentials: true });
  }

  logout(): Observable<any> {
    return this.http.get('http://51.75.162.147:8080/auth/logout', { withCredentials: true });
  }
